...
Recipe cache shard for **[foodrecipes.page](https://foodrecipes.page)** — AI-generated recipes whose slug starts with **the letter 'w'**.
...
```
https://cdn.jsdelivr.net/gh/foodrecipes-page/recipes-w@main/recipes/<cuisine>/<diet>/<slug>.json
```
